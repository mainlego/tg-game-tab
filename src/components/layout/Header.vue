...
onMounted(() => {
  if (tg.value) {
    console.log('Telegram user data:', user.value)  // Добавим логирование для отладки
  }
})
</script>
